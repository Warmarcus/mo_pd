local peds = {
    ...
    {ishash=true, model= 0xe497bbef, dict="mini@strip_club@idles@bouncer@base", anim="base", voice="S_M_M_HAIRDRESSER_01_BLACK_MINI_01", coords={-2036.8909912109,-1033.7723388672,4.8823900222778,250.0}}, 
...
Citizen.CreateThread(function()
  ...
  -- Misc
  ped = CreatePed(4, 1885233650, 443.59710693359, -983.61791992188,30.689311981201, 532.21, false, true) -- Spawner Ped
